...
function updateUserInfo() {
  ...
  let payload = JSON.stringify({ sessionID: SESSION_ID, email: $("#email").val(),fName: $("#fName").val(), lName: $("#lName").val(), phoneNo: $("#phoneNo").val()});
...
function updateUserPassword() {
  ...
  let payload = JSON.stringify({ sessionID: SESSION_ID, currentPassword: $("#currentPassword").val(),newPassword: $("#newPassword").val()});
